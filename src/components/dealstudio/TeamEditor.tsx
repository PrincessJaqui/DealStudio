  ...
  return (
    <div>
      ...
      <div className="mt-1 flex items-center gap-3">
        <div className="h-14 w-14 shrink-0 overflow-hidden rounded-full border border-[#edf0f3] bg-[#f0f7ea] flex items-center justify-center">
          {url ? <img src={url} alt="" className="h-full w-full object-cover" /> : <ImageIcon className="w-5 h-5 text-[#9bbf86]" />}
        </div>
        <label className={`inline-flex items-center gap-1.5 rounded-xl border border-[#cfe6b8] bg-white px-3 py-2 text-sm font-medium text-[#5d8f41] ${uploading ? 'opacity-60' : 'hover:bg-[#f0f7ea] cursor-pointer'}`}>
  ...
  return (
    <div>
      ...
      <div className="mt-1 flex flex-wrap items-center gap-3">
        {url ? (
          <a href={url} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 rounded-xl border border-[#cfe6b8] bg-[#f0f7ea] px-3 py-2 text-sm font-medium text-[#5d8f41] hover:bg-[#e5f0d8] max-w-[220px]">
